...
export default class Stage extends StageBase {
  constructor(...args) {
    ...
    this.vars.n = 2.4012465301967068e82;
    this.vars.t = 1000000954.7409539;
    this.vars.nShow = "n(1000000955) = 2.4012465301967068e+82";
    this.vars.reqalphapow = 334404880.59472233;
    this.vars.alphapower = 27;
    this.vars.reqalphapowermul = 1.55;
    this.vars.goals2 = 6;
    this.vars.aloveLevel = 126;
    this.vars.aloveReq = 5.4277541829991967e82;
    this.vars.score = 41.19021837515715;
    this.vars.scorecom = 0;
    this.vars.scoreShow = "Score:41 / 0";
    this.vars.betapower = 57;
    this.vars.reqbetapow = 117;
    this.vars.reqbetapowmul = 0;
    this.vars.upgraderbetareq1 = 42;
    this.vars.upgradebetaeffect1 = 8.36682554252848e22;
    this.vars.upgraderbetaeffect2 = 4;
    this.vars.upgraderbetareq2 = 51;
    ...
    this.vars.gammapower = 15;
    this.vars.reqgammapow = 130;
    this.vars.upgradergammareq1 = 14;
    this.vars.upgradergammaeffect1 = 8899.684222557531;
    this.vars.upgradergammareq2 = 12;
    this.vars.upgradergammaeffect2 = 1;
    this.vars.seconds = 5960.9021761911135;
    this.vars.days = 75;
    this.vars.daysEffect = 8.717797887081348;
    this.vars.clockactive = 1;
    this.vars.daysStart = 1;
    this.vars.secondShow = 2.5;
    this.vars.functions = 1;
    this.vars.reqfunction = 1000000;
